...
var str = "I used to have this habit of taping small images\\to the walls of my bedroom — \\photos, postcards, and drawings from here and there. \\This winter, \\one day I was staring at the constellation of images on my walls,\\ somewhat listlessly, \\when I suddenly got so tired of them. \\Suddenly every image seemed utterly replaceable with any other image. \\Entirely uninteresting, \\it seemed like any source of uniqueness or value \\merely came from an arbitrary reordering of ink on paper. \\Or, in the case of digitally represented images, \\simply a random permutation of pixel values on a screen. \\The digital image felt like a lifeless being. \\I asked myself: \\as a graphic designer,\\ I’ve developed a visual literacy through exposure to as many different visual styles as possible. \\But at the end of all that, \\do I have any real attachment to any piece of graphic work? \\Have I ever? \\If not,\\ then what even is the point of claiming to be an image-maker? \\Let’s be honest with ourselves, \\Doesn’t every poster essentially look the same? \\Doesn’t every typeface look the same? \\Isn’t every are.na channel basically filled with the same images? \\Bare walls and blank sheets of paper \\seem to offer so much more prospect and possibility,\\ and any commitment to a particular decision seemed so arbitrary and limiting. \\I never want to see the same image twice ever again. \\This is,\\ of course,\\ the most tongue-in-cheek of statements, \\but there is still some truth to the sentiment.";
