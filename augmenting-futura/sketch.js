var textArray = ["QUEER— FUTURA", "FEMME— FUTURA", "TRANS— FUTURA", "AFRO— FUTURA", "LATINX— FUTURA", "INDIGENOUS— FUTURA", "ASIA— FUTURA", "ALT— FUTURA", "WHOSE UTOPIA?", "WHOSE FUTURE?", "WHOSE FUTURA?"];
var randArray = [];
